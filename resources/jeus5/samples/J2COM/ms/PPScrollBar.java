...
public class PPScrollBar extends DispatchPtr
{
	public PPScrollBar(String progid) throws COMException { super(progid);}
	public PPScrollBar(IUnknown other) throws COMException { super(other);}

	public PPScrollBar(GUID ClsID) throws COMException { super(ClsID);}
	...
	public String getOnScroll() throws COMException
	{
		return (String) get("OnScroll");
	}

	public void setOnScroll(String pString) throws COMException
	{
		put("OnScroll", pString);
	}
