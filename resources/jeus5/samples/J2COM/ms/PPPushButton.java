...
public class PPPushButton extends DispatchPtr
{
	public PPPushButton(String progid) throws COMException { super(progid);}
	public PPPushButton(IUnknown other) throws COMException { super(other);}

	public PPPushButton(GUID ClsID) throws COMException { super(ClsID);}
