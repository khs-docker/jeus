    ...
    function Plot(target_, data_, options_) {
        ...
        function insertLegend() {
            ...
            if (fragments.length > 0) {
                var table = '<table style="position:absolute;left:10px;font-size:smaller;color:' + options.grid.color + '">' + fragments.join("") + '</table>';
                if (options.legend.container != null)
                    ...
                    if (p.charAt(1) == "e")
                        ...
                        pos += 'left:' + (m + plotOffset.bottom) + 100 +'px;';
                    ...
                    if (options.legend.backgroundOpacity != 0.0) {
                        ...
                        $('<div style="position:absolute;width:' + div.width() + 'px;height:' + div.height() + 'px;' + pos + ';"> </div>').appendTo(target).css('opacity', options.legend.backgroundOpacity);
