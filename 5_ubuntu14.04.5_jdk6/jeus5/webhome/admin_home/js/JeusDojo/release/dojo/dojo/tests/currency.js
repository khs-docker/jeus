	...
	[
		{
			...
			setUp: function(){
				...
				for(var i = 0 ; i < partLocaleList.length; i ++){
					dojo.requireLocalization("dojo.cldr","currency",partLocaleList[i], "zh-tw,ko,en,pt,en-us,it,es,ja,en-au,fr,de,en-ca,zh,ROOT");
					dojo.requireLocalization("dojo.cldr","number",partLocaleList[i], "zh-tw,ROOT,ko,en,zh-cn,ko-kr,pt,es-es,de-de,en-us,it,es,ja,en-au,ja-jp,en-gb,fr,de,zh");
				}
			},
			runTest: function(t){
