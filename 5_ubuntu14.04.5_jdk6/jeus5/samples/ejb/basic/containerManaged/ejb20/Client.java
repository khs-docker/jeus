...
public class Client
{
   ...
   public static void main(String[] arg) throws Exception
   {
      ...
      Object objref = initial.lookup("book_cmp20");
      ...
      for (int i = 0; i < number; i++)
      {
         ...
         System.out.println("Creating bean with ID " + (ID + i) + ", title " + (TITLE + i) + ", author " + (AUTHOR + i) + ", price " + ((23.2 * i) + 5) + " and publisher " + PUBLISHER);
      }
