...
{
    private String id; // as the primary key
    private String name;
    private double price;
    private EntityContext ctx;

    public String ejbCreate(String id, String name, double price)
        throws CreateException
    {
        ...
        {
            throw new CreateException("Fail to create.");
        }
        ...
        try
        {
            ...
            if (!rs.next())
            {
                throw new ObjectNotFoundException(
                    "Fail to find product_basbmp with id '" + id + "'");
            }
        }
    ...
    public Collection ejbFindInPriceRange(double min, double max)
    ...
    private Connection getConnection() throws SQLException
    {
        ...
        try
        {
            ...
            ds = (DataSource)initial.lookup("SampleDS");
        }
