...
<script language="javascript" src="/web-sample/js/common.js"></script>
	...
	<table width="776" border="0" cellspacing="0" cellpadding="0">
		...
		<a href="/web-sample/ko/jsp_main.html">JSP </a>&gt; SimpleTag</td>
		</tr>
	</table>
	<br>
	<table width="776" border="0" cellspacing="0" cellpadding="0">
		<tr>
		<td width="22">&nbsp;</td>
		<td width="145" valign="top" background="/web-sample/images/b_bg.gif"><a href="intro.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub01','','/web-sample/images/b_me1_up.gif',1)"><img src="/web-sample/images/b_me1.gif" name="sub01" width="145" height="26" border="0"></a><a href="simpletag.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub02','','/web-sample/images/b_me2_up.gif',1)"><img src="/web-sample/images/b_me2.gif" name="sub02" width="145" height="26" border="0"></a><a href="build.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub03','','/web-sample/images/b_me3_up.gif',1)"><img src="/web-sample/images/b_me3.gif" name="sub03" width="145" height="26" border="0"></a>
		</td>
		...
		<br><br>
	    <P class='JMHeading1'>JSP 2.0 SimpleTag Handler</P>
		<P class="JMHeading4">
		    <b><u>Result : </u></b>
		    <jsp2:simpletag/>
		    </P>
