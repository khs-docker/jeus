...
public class SlideRange extends DispatchPtr
{
	public SlideRange(String progid) throws COMException { super(progid);}
	public SlideRange(IUnknown other) throws COMException { super(other);}

	public SlideRange(GUID ClsID) throws COMException { super(ClsID);}
