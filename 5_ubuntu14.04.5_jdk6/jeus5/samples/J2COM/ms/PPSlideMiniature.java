...
public class PPSlideMiniature extends DispatchPtr
{
	public PPSlideMiniature(String progid) throws COMException { super(progid);}
	public PPSlideMiniature(IUnknown other) throws COMException { super(other);}

	public PPSlideMiniature(GUID ClsID) throws COMException { super(ClsID);}
	...
	public void SetImage(_Slide Slide) throws COMException
	{
		invokeN("SetImage", new Object[] {new _Slide(Slide)});
	}

	public int getSelected() throws COMException
	{
		return ((Integer) get("Selected")).intValue();
	}

	public void setSelected(int pint) throws COMException
	{
		put("Selected", new Integer(pint));
	}
