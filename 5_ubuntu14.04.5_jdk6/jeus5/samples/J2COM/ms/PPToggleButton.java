...
public class PPToggleButton extends DispatchPtr
{
	public PPToggleButton(String progid) throws COMException { super(progid);}
	public PPToggleButton(IUnknown other) throws COMException { super(other);}

	public PPToggleButton(GUID ClsID) throws COMException { super(ClsID);}
