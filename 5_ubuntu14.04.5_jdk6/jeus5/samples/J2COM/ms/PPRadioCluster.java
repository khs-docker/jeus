...
public class PPRadioCluster extends DispatchPtr
{
	public PPRadioCluster(String progid) throws COMException { super(progid);}
	public PPRadioCluster(IUnknown other) throws COMException { super(other);}

	public PPRadioCluster(GUID ClsID) throws COMException { super(ClsID);}
	...
	public PPRadioButton Item(Object index) throws COMException
	{
		return (new PPRadioButton((DispatchPtr)invokeN("Item", new Object[] {index})));
	}

	public PPRadioButton Add(float Left, float Top, float Width, float Height) throws COMException
	{
		return (new PPRadioButton((DispatchPtr)invokeN("Add", new Object[] {new Float(Left), new Float(Top), new Float(Width), new Float(Height)})));
	}
	...
	public PPRadioButton getSelected() throws COMException
	{
		return ( new PPRadioButton((DispatchPtr)  get("Selected")));
	}
