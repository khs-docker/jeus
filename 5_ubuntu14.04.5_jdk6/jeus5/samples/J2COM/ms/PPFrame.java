...
public class PPFrame extends DispatchPtr
{
	public PPFrame(String progid) throws COMException { super(progid);}
	public PPFrame(IUnknown other) throws COMException { super(other);}

	public PPFrame(GUID ClsID) throws COMException { super(ClsID);}
