...
public class ShapeRange extends DispatchPtr
{
	public ShapeRange(String progid) throws COMException { super(progid);}
	public ShapeRange(IUnknown other) throws COMException { super(other);}

	public ShapeRange(GUID ClsID) throws COMException { super(ClsID);}
	...
	public Shape Group() throws COMException
	{
		return (new Shape((DispatchPtr)invoke("Group")));
	}

	public Shape Regroup() throws COMException
	{
		return (new Shape((DispatchPtr)invoke("Regroup")));
	}

	public void Align(int AlignCmd, int RelativeTo) throws COMException
	{
		invokeN("Align", new Object[] {new Integer(AlignCmd), new Integer(RelativeTo)});
	}

	public void Distribute(int DistributeCmd, int RelativeTo) throws COMException
	{
		invokeN("Distribute", new Object[] {new Integer(DistributeCmd), new Integer(RelativeTo)});
	}

	public void GetPolygonalRepresentation(int maxPointsInBuffer, float pPoints, int numPointsInPolygon, int IsOpen) throws COMException
	{
		invokeN("GetPolygonalRepresentation", new Object[] {new Integer(maxPointsInBuffer), new Float(pPoints), new Integer(numPointsInPolygon), new Integer(IsOpen)});
	}
