...
public class PPIcon extends DispatchPtr
{
	public PPIcon(String progid) throws COMException { super(progid);}
	public PPIcon(IUnknown other) throws COMException { super(other);}

	public PPIcon(GUID ClsID) throws COMException { super(ClsID);}
