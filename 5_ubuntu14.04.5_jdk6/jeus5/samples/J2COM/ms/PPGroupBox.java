...
public class PPGroupBox extends DispatchPtr
{
	public PPGroupBox(String progid) throws COMException { super(progid);}
	public PPGroupBox(IUnknown other) throws COMException { super(other);}

	public PPGroupBox(GUID ClsID) throws COMException { super(ClsID);}
