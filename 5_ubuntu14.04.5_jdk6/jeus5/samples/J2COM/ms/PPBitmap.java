...
public class PPBitmap extends DispatchPtr
{
	public PPBitmap(String progid) throws COMException { super(progid);}
	public PPBitmap(IUnknown other) throws COMException { super(other);}

	public PPBitmap(GUID ClsID) throws COMException { super(ClsID);}
