...
public class PPControl extends DispatchPtr
{
	public PPControl(String progid) throws COMException { super(progid);}
	public PPControl(IUnknown other) throws COMException { super(other);}

	public PPControl(GUID ClsID) throws COMException { super(ClsID);}
