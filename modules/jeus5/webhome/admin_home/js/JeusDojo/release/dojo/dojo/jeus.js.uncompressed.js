		...
		_position: function(){
			...
			if(!dojo.hasClass(dojo.body(),"dojoMove")){
				...
				dojo.style(node,{
					...
					top:  Math.max(0, Math.floor(viewport.t + (p ? p.t : (viewport.h - mb.h) / 2))) + "px"
				});
			}
...
dojo.i18n._preloadLocalizations("dojo.nls.jeus", ["he","nl","tr","no","ko","el","en","en-gb","ROOT","zh-cn","hu","es","fi-fi","pt-br","ca","fi","he-il","xx","ru","it","fr","cs","de-de","fr-fr","it-it","es-es","ja","sk","da","sl","pl","de","sv","pt","pt-pt","nl-nl","zh-tw","ko-kr","ar","en-us","zh","th","ja-jp"]);
