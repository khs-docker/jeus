...
public class PPDropDown extends DispatchPtr
{
	public PPDropDown(String progid) throws COMException { super(progid);}
	public PPDropDown(IUnknown other) throws COMException { super(other);}

	public PPDropDown(GUID ClsID) throws COMException { super(ClsID);}
