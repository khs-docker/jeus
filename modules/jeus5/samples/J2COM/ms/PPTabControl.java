...
public class PPTabControl extends DispatchPtr
{
	public PPTabControl(String progid) throws COMException { super(progid);}
	public PPTabControl(IUnknown other) throws COMException { super(other);}

	public PPTabControl(GUID ClsID) throws COMException { super(ClsID);}
