...
public class PPDropDownEdit extends DispatchPtr
{
	public PPDropDownEdit(String progid) throws COMException { super(progid);}
	public PPDropDownEdit(IUnknown other) throws COMException { super(other);}

	public PPDropDownEdit(GUID ClsID) throws COMException { super(ClsID);}
	...
	public String getOnEdit() throws COMException
	{
		return (String) get("OnEdit");
	}

	public void setOnEdit(String pString) throws COMException
	{
		put("OnEdit", pString);
	}
