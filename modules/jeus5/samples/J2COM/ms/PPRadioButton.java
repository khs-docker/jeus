...
public class PPRadioButton extends DispatchPtr
{
	public PPRadioButton(String progid) throws COMException { super(progid);}
	public PPRadioButton(IUnknown other) throws COMException { super(other);}

	public PPRadioButton(GUID ClsID) throws COMException { super(ClsID);}
	...
	public void DoubleClick() throws COMException
	{
		invoke("DoubleClick");
	}
